...
class crawler:
    ...
    # Auxiliary function for getting an entry id and adding it if
    # it's not present.
    ...
    # Return number of pages added on this execution.
    def totallinks(self):
    ...
    # Separate the word by any non-whitespace character.
